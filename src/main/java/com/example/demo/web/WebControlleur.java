...
public class WebControlleur {
	...
	@RequestMapping(value="movie/supMovie",method=RequestMethod.GET)
	public String supMovie(@Valid @ModelAttribute Movie a,
	BindingResult bindingResult) {
	if (bindingResult.hasErrors()){
	return "supMovie";
	}
	...
	@RequestMapping(value="room/supRoom",method=RequestMethod.GET)
	public String supRoom(@Valid @ModelAttribute Room a,
	BindingResult bindingResult) {
	if (bindingResult.hasErrors()){
	return "supRoom";
	}
